(function() {
    ...
    var t = function(a) {
        ...
        ee = function(a, b) {
            return aa(I.location[b ? "href" : "search"], a)
        },
        aa = function(a, b) {
            return (a = a.match("(?:&|#|\\?)" +
        ...
        Xb = function(a, b) {
            ...
            if (/^(https?|android-app):\/\//i.test(c)) {
                ...
                if (!Be(c, a)) return b && (b = a.replace(/\./g, "-") + ".cdn.ampproject.org", Be(c, b)) ? void 0 :
                    c
            }
        },
        Yb = function(a, b) {
    ...
    function Fa(a, b) {
        ...
        if (sa(a)) {
            if (3 < b) return "[...]";
            b = [];
            for (var d = 0; d < a.length; d++) b.push(Fa(a[d], c + 1));
            return "[" + b.join(", ") + "]"
        }
        if (a.constructor == Object) {
            if (3 < b) return "{...}";
            b = [];
            for (d in a) b.push(d + ": " + Fa(a[d], c + 1));
            return "{" + b.join(", ") + "}"
        }
        return "" + a
    }
    ...
    var Md = function(a) {
        ...
        pe = function(a, b, c, d, e, f) {
            K(e) ? ("function" == typeof N && N("Aborting cookie write: User has opted out of tracking."), e = !1) : Wd.test(I.location.hostname) || "/" == c && fe.test(d) ? ("function" == typeof N && N("Aborting cookie write: Prohibited domain."), e = !1) : e = !0;
            if (!e) return !1;
            b && 1200 < b.length && (b = b.substring(0, 1200));
            c = a + "=" + b + "; path=" + c + "; ";
            f &&
                (c += "expires=" + (new Date((new Date).getTime() + f)).toGMTString() + "; ");
            d && "none" !== d && (c += "domain=" + d + ";");
            d = I.cookie;
            I.cookie = c;
            if (!(d = d != I.cookie)) a: {
    ...
    var hd, Ee = /^.*Version\/?(\d+)[^\d].*$/i,
        ff = function() {
            if (void 0 !== Q.__ga4__) return Q.__ga4__;
            if (void 0 === hd) {
                ...
                if (a) {
                    ...
                    if (a = !(0 <= b.indexOf("Chrome")) && !(0 <= b.indexOf("CriOS")) && (0 <= b.indexOf("Safari/") || 0 <= b.indexOf("Safari,"))) b = Ee.exec(b), a = 11 <= (b ? Number(b[1]) : -1);
                    hd = a
                } else hd = !1
            }
            return hd
    ...
    var Da, Sb, cc, dc, ma = /^https?:\/\/[^/]*cdn\.ampproject\.org\//,
        ...
        $c = function(a, b) {
            ...
            if (void 0 !== dc) return F(56), ta(function() {
                a(dc)
            }, 0), !0;
            if (Da) return sc.push(a), !0;
            if ("$RETRIEVING" == c) return F(57), ta(function() {
                $c(a, b)
            }, 1E4), !0;
            Da = !0;
            c && "$" != c[0] || (ed("$RETRIEVING", 3E4), setTimeout(jd,
                3E4), c = "");
            return ld(c, b) ? (sc.push(a), !0) : !1
        },
        ld = function(a, b, c) {
            ...
            if (!d) return F(59), !1;
            var e = new d;
            if (!("withCredentials" in e)) return F(60), !1;
            ...
            e.onload = function() {
                ...
                if (4 == e.readyState) {
                    try {
                        200 != e.status && (J("Could not get client id from AMP."), F(61),
                            yd("", "$ERROR", 3E4));
                        var d = JSON.parse(e.responseText);
                        d.optOut ? (J("Could not get client id from AMP. User has opeted out."), F(63), yd("", "$OPT_OUT", 31536E6)) : d.clientId ? (N("Got client id from AMP."), yd(d.clientId, d.securityToken, 31536E6)) : !c && d.alternateUrl ? (N("Got an alternate URL to get client id."), Sb && clearTimeout(Sb), Da = !0, ld(a, b, d.alternateUrl)) : (J("Could not get client id from AMP."), F(64), yd("", "$NOT_FOUND", 36E5))
                    } catch (ea) {
                        J("Could not get client id from AMP."), F(65), yd("", "$ERROR", 3E4)
                    }
                    e =
                        null
                }
        ...
        ed = function(a, b) {
            if (void 0 === cc) {
                cc = "";
                for (var c = fd(), d = 0; d < c.length; d++) {
                    var e = c[d];
                    if (pe("AMP_TOKEN", encodeURIComponent(a), "/", e, "", b)) {
                        cc = e;
                        return
                    }
                }
            }
            pe("AMP_TOKEN", encodeURIComponent(a), "/", cc, "", b)
        },
        yd = function(a, b, c) {
            Sb && clearTimeout(Sb);
            b && ed(b, c);
    ...
    var gf = function() {
            return ($b || "https:" == I.location.protocol ? "https:" : "http:") + "//www.google-analytics.com"
        },
        bc = function(a) {
            this.name = "len";
            this.message = a + "-8192"
            ...
            f.onreadystatechange = function() {
                if (4 == f.readyState) {
                    if (d) try {
                        ...
                        if (1 > a.length) fc("xhr", "ver", "0"), c();
                        else if ("1" != a.charAt(0)) fc("xhr", "ver", String(a.length)), c();
                        else if (3 < d.count++) fc("xhr", "tmr",
                            "" + d.count), c();
                        else if (1 == a.length) c();
                        else {
                            var b = a.charAt(1);
                            if ("d" == b) hf("https://stats.g.doubleclick.net/j/collect", d.Y, d, c);
                            else if ("g" == b) {
                                ...
                                if (v)
                                    if (/^[a-z.]{1,6}$/.test(v)) {
                                        var ka = "https://www.google.%/ads/ga-audiences".replace("%", v);
                                        id(ka, d.google, Aa)
                                    } else fc("tld", "bcc", v)
                            } else fc("xhr", "brc", b), c()
                        }
        ...
        u = function(a, b, c) {
            return Q.navigator.sendBeacon ?
                Q.navigator.sendBeacon(a, b) ? (c(), !0) : !1 : !1
        },
        fc = function(a, b, c) {
            O("Error: type=%s method=%s message=%s account=%s", arguments);
            if (!(1 <= 100 * Math.random() || K("?"))) {
                var d = ["t=error", "_e=" + a, "_v=j68d", "sr=1"];
                b && d.push("_f=" + b);
    ...
    function kc(a) {
        if (K(V(a, U))) throw N("User has opted out of tracking. Aborting hit."), "abort";
    }
    ...
    function mc(a) {
        ...
        var b = [];
        Ka.map(function(c, d) {
            d.i && (c = a.get(c), void 0 != c && c != d.defaultValue && ("boolean" == typeof c && (c *= 1), b.push(d.i + "=" + P("" + c))))
        });
        b.push("z=" + be());
        a.set(Na, b.join("&"), !0)
    }
    ...
    function pc(a) {
        var b = V(a, ob) || gf() + "/collect",
            c = a.get(kf),
            d = V(a, ha);
        !d && a.get(Oe) && (d = "beacon");
        if (c) hf(b, V(a, Na), c, a.get(Nb));
        else if (d) {
            c = d;
            d = V(a, Na);
            var e = a.get(Nb);
    ...
    var Ob = X("_oot"),
        ...
        ue = X("_gclid"),
        Ge = X("_gt"),
        Qe = X("_ge", void 0, 7776E6),
        Ve = X("_gclsrc"),
        We = X("storeGac", void 0, !0),
        ac = [T, U, R,
            n, xe, ub, S, vb, Cb, Yd, wb, Id, Kb, Lb, Db, Eb, Mb, xb, ce, We
        ],
        ob = W("transportUrl"),
        De = W("_r", "_r"),
        kf = W("_dp"),
        df = W("allowAdFeatures", void 0, !0);
    ...
    var Ie = function() {
        ...
        ye = function(a) {
            ...
            b.fa = !0;
            if (a) {
                if (b.ra && void 0 !== a.get(b.ra)) return jc(a, b.ra);
                if (0 == a.get(Eb)) return 0
            }
            if (0 == b.Z) return 0;
            void 0 === c && (c = be());
            return 0 == c % b.Z ? Math.floor(c / b.Z) % b.groups + 1 : 0
        };
    ...
    var ba = function(a) {
        ...
        Sc = function(a) {
            ...
            if (qd(b) || rd(b)) {
                var c = b[Ic];
                void 0 == c || Infinity == c || isNaN(c) ? L("Site speed data not sent - unsupported browser") : 0 < c ? (Rc(b, Kc), Rc(b, Nc), Rc(b, Mc), Rc(b, Jc), Rc(b, Lc), Rc(b, Oc), Rc(b, Pc), ta(function() {
                    a(b)
                }, 10)) : (L("Site speed data not available - waiting for onload"), Ca(Q, "load", function() {
                    Sc(a)
                }, !1))
    ...
    var Tc = !1,
        Yc = function(a) {
            if ("cookie" == V(a, xb)) {
                ...
                if (a.get(We)) {
                    var c = a.get(ue);
                    if (c) {
                        var d = Math.min(jc(a, Qe), 1E3 * jc(a, Cb));
                        d = Math.min(d, 1E3 * jc(a, Ge) + d - (new Date).getTime());
                        a.data.set(Qe, d);
                        b = {};
                        var e = a.get(Ge),
                            f = a.get(Ve),
                            ...
                            l = Xc(V(a, S)),
                            k = V(a, U);
                        f && "aw.ds" != f ? b && (b.xa = !0) : (c = ["1", e, Ae(c)].join("."), 0 < d && (b && (b.wa = !0), pe("_gac_" + Ae(k), c, ea, l, k, d)));
                        Ye(b)
                    }
                } else F(75);
                if (a = "none" === Xc(V(a, S))) a = I.location.hostname,
                    a = Wd.test(a) || fe.test(a);
                a && F(30)
            }
        },
        oa = function(a, b, c, d) {
            ...
            if (e) {
                ...
                var f = Wc(V(a, vb)),
                    ea = Xc(V(a, S)),
                    l = V(a, U);
                if ("auto" != ea) pe(c, e, f, ea, l, d) && (Tc = !0);
                else {
                    F(32);
                    for (var k = fd(), v = 0; v < k.length; v++)
                        if (ea = k[v], a.data.set(S, ea), e = ie(a, b), pe(c, e, f, ea, l, d)) {
                            N("Auto cookieDomain found: %s", ea);
                            Tc = !0;
                            return
                        }
        ...
        ie = function(a, b) {
            b = Ae(V(a, b));
            var c = Xc(V(a, S)).split(".").length;
            a = Vc(V(a, vb));
            1 < a && (c += "-" + a);
            return b ? ["GA1", c, b].join(".") : ""
        },
        de = function(a, b) {
            return pa(b, V(a, S), V(a, vb))
        },
        pa = function(a, b, c) {
            if (!a || 1 > a.length) F(12);
                ...
                for (var d = [], e = 0; e < a.length; e++) {
                    ...
                    var ea = f.split(".");
                    var l = ea.shift();
                    ("GA1" == l || "1" == l) && 1 < ea.length ? (f = ea.shift().split("-"),
                        1 == f.length && (f[1] = "1"), f[0] *= 1, f[1] *= 1, ea = {
                            K: f,
                            M: ea.join(".")
                        }) : Cd.test(f) ? ea = {
                        K: [0, 0],
                        M: f
                    } : (J("Unknown cookie version: " + l), ea = void 0);
                    ea && d.push(ea)
                }
                ...
                if (0 == d.length) F(12);
                    ...
                    F(14);
                    d = sd(d, Xc(b).split(".").length, 0);
                    if (1 == d.length) return d[0].M;
                    d = sd(d, Vc(c), 1);
                    1 < d.length && F(41);
                    return d[0] && d[0].M
                }
    ...
    function Ld(a, b) {
        if (null == a) var c = a = 1;
        else c = ic(a), a = ic(H(a, ".") ? a.substring(1) : "." + a);
        for (var d = 0; d < b.length; d++)
    ...
    function nd(a) {
        var b = a.get(R),
            c = a.get(la) || "";
        b = "_ga=2." + P(ra(c + b, 0) + "." + c + "-" + b);
        if ((c = a.get(ue)) && a.get(We)) {
            var d = jc(a, Ge);
            1E3 * d + jc(a, Qe) <= (new Date).getTime() ? (F(76), a = "") : (F(44), a = "&_gac=1." + P([ra(c, 0), d, c].join(".")))
        } else a = "";
        return b + a
    }
    ...
    function ra(a, b) {
        ...
        return ic([a, d.userAgent, d.language || "", c.getTimezoneOffset(), c.getYear(), c.getDate() + Math.floor(e / 24), (24 + e) % 24, (60 + c.getMinutes() + b) % 60].join("."))
    }
    var pd = function(a) {
        F(48);
        this.target = a;
    ...
    var le = function(a, b, c) {
            ...
            (d = Ze.exec(b)) && 3 <= d.length && (b = d[1] + (d[3] ? d[2] + d[3] : ""));
                    ...
                    if (N("Linker decorating form: %s", b), "get" == b.method.toLowerCase()) {
                        ...
                        for (var c = 0; c < a.length; c++) {
                            var d = a[c].split("="),
                                e = d[1];
                            d = d[0];
                            for (var f = b.childNodes || [], ea = !1, l = 0; l < f.length; l++)
                                if (f[l].name == d) {
                                    f[l].setAttribute("value", e);
                                    ea = !0;
                                    break
                                }
                            ea || (f = I.createElement("input"), f.setAttribute("type", "hidden"), f.setAttribute("name", d), f.setAttribute("value", e), b.appendChild(f))
                        }
    ...
    pd.prototype.U = function(a, b, c) {
        function d(c) {
            try {
                ...
                "http:" != f.protocol && "https:" != f.protocol || !ne(a, f.hostname || "") || (f.href && (f.href = le(e, f.href, b)), N("Link decorated: " + f.href))
            } catch (k) {
                F(26)
            }
        }
    ...
    function Xe(a, b) {
        return b != ud(a, 0) && b != ud(a, -1) && b != ud(a, -2) && b != ra(a, 0) && b != ra(a, -1) && b != ra(a, -2)
    };
    var p = /^(GTM|OPT)-[A-Z0-9]+$/,
        ...
        w = function(a) {
            ...
            b("cycle", a.J);
            a.ta && b("gclid", a.ta);
            ua.test(I.referrer) && b("cb", String(ae()));
            return c
        };
    var Fe = function(a, b, c) {
            ...
            b.set(Vb, function(b) {
                ...
                if (mf(b)) {
                    if (ff() !== ca(a, b)) {
                        ...
                        hf("https://stats.g.doubleclick.net/j/collect", e.Y, e)
                    } else za(lf(a, b, 0));
                    b.set(Zd, "", !0)
                }
                return c
        ...
        Je = function(a, b, c) {
            !1 !== b.get(df) &&
                (b.get(c) ? J("Join id already set: " + c) : "1" == Md(a.aa)[0] ? b.set(c, "", !0) : b.set(c, "" + ae(), !0))
        },
        Ke = function(a, b) {
            mf(b) && (N("Setting throttling cookie: %s", a.aa), pe(a.aa, "1", b.get(vb), b.get(S), b.get(U), 6E4))
        },
        mf = function(a) {
            return !!a.get(Zd) && a.get(df)
        },
        lf = function(a, b, c) {
            var d = new ef,
                e = function(a) {
                    yc(a).i && d.set(yc(a).i, b.get(a))
                };
            e(Gc);
            e(Hc);
            e(U);
            ...
            f += "z=" + ae();
            0 == c ? (f = a.ca + f, od(d,
                f)) : 1 == c ? f = "t=dc&aip=1&_r=3&" + f : 2 == c && (f = "t=sr&aip=1&_r=4&slf_rd=1&" + f);
            return f
        },
        ca = function(a, b) {
            null === a.ua && (a.ua = 1 === ye(b), a.ua && F(33));
            return a.ua
        },
        Pe = /^gtm\d+$/;
    var $d = function(a, b) {
        ...
        if (!a.get("dcLoaded")) {
            ...
            var d;
            b[ub] && (d = Ae(b[ub]));
            b = new Fe(a, "https://stats.g.doubleclick.net/r/collect?t=dc&aip=1&_r=3&", d);
            Le(b, a);
            a.set("dcLoaded", !0)
        }
    };
    var Me = function(a) {
        if (!a.get("dcLoaded") && "cookie" == a.get(xb)) {
            ...
            if (mf(a)) {
                var c = ff() !== ca(b, a);
                a.set(De, 1, !0);
                c ? (F(79), a.set(ob, gf() + "/j/collect", !0), a.set(kf, {
                    Y: lf(b, a, 1),
                    google: lf(b, a, 2),
                    count: 0
                }, !0)) : a.set(ob, gf() + "/r/collect", !0)
            }
        }
    };
    var He = function() {
        ...
        vd = function(a, b) {
            ...
            if ("cookie" == V(a, xb)) {
                ...
                if (!c) {
                    ...
                    var d = V(a, wb) || Wb();
                    c = Jd("__utma", d, c);
                    void 0 != c ? (F(10), d = c.ea[1] + "." + c.ea[2], Ga("Loaded legacy client id from utma cookie: %s (hash=%s)",
                        d, c.hash), c = d) : c = void 0
                }
                c && (Tc = !0);
                if (d = c && !a.get(Yd))
                ...
                if (a.get(We) && (c = a.get(ue), d = a.get(Ve), !c || d && "aw.ds" != d)) {
                    c = {};
                    if (I) {
                        d = [];
                        e = I.cookie.split(";");
                        for (var f = /^\s*_gac_(UA-\d+-\d+)=\s*(.+?)\s*$/, ea = 0; ea < e.length; ea++) {
                            var l = e[ea].match(f);
                            l && d.push({
                                ma: l[1],
                                value: l[2]
                        ...
                        e = {};
                        if (d && d.length)
                            for (f = 0; f < d.length; f++)(ea = d[f].value.split("."), "1" != ea[0] || 3 != ea.length) ? c && (c.qa = !0) : ea[1] && (e[d[f].ma] ? c && (c.sa = !0) : e[d[f].ma] = [], e[d[f].ma].push({
                                timestamp: ea[1],
                                ta: ea[2]
                            }));
                        d = e
                    ...
                    d = d[V(a, U)];
                    Ye(c);
                    d && 0 != d.length && (c = d[0], a.data.set(Ge, c.timestamp), a.data.set(ue, c.ta))
                }
            }
            if (a.get(Yd)) a: if (c = ee("_ga", a.get(Lb)))
                if (a.get(Kb))
                    if (e = c.indexOf("."), -1 == e) J("Invalid linker parameter format: " + c), F(22);
                        ...
                        if ("1" == ea) {
                            if (e = f, Xe(e, d)) {
                                J("Bad or expired linker parameter hash: " + c);
                                F(23);
                                break a
                            }
                        } else if ("2" == ea) {
                            e = f.indexOf("-");
                            ea = "";
                            0 < e ? (ea = f.substring(0, e), e = f.substring(e + 1)) : e = f.substring(1);
                            if (Xe(ea + e, d)) {
                                J("Bad or expired linker parameter hash: " + c);
                                F(53);
                                break a
                            }
                            ea && (Ga("Loaded gid: " + ea), F(2), a.data.set(la, ea))
                        } else {
                            J("Unrecognized linker parameter version: " + c);
                            F(22);
                            break a
                        }
                        Ga("Loaded client id: " + e);
                        F(11);
                        a.data.set(R, e);
                        if (c = ee("_gac",
                                a.get(Lb))) c = c.split("."), "1" != c[0] || 4 != c.length ? F(72) : Xe(c[3], c[1]) ? F(71) : (a.data.set(ue, c[3]), a.data.set(Ge, c[2]), F(70))
                    }
            else J("Linker disabled. Ignoring linker parameter: " + c), F(21);
            b && (Ga("Used client Id from constructor."), F(9), a.data.set(R, P(b)));
            a.get(R) || ((b = (b = Q.gaGlobal && Q.gaGlobal.vid) && -1 != b.search(Bd) ? b : void 0) ? (Ga("New visitor. Copying new clientId"), F(17), a.data.set(R, b)) : (Ga("New visitor. Generating new clientId"), F(8), a.data.set(R, ia())));
            a.get(la) || (Ga("Generating new gid"), F(3),
                a.data.set(la, ia()));
            Yc(a)
        },
        wd = function(a) {
            ...
            a.data.set(ue, ee("gclid", !0));
            a.data.set(Ve, ee("gclsrc", !0));
            a.data.set(Ge, Math.round((new Date).getTime() / 1E3));
            if (d && a.get(Lb) && (b = I.location.hash)) {
                b = b.split(/[?&#]+/);
                d = [];
                for (c = 0; c < b.length; ++c)(H(b[c], "utm_id") || H(b[c], "utm_campaign") || H(b[c], "utm_source") || H(b[c],
                    "utm_medium") || H(b[c], "utm_term") || H(b[c], "utm_content") || H(b[c], "gclid") || H(b[c], "dclid") || H(b[c], "gclsrc")) && d.push(b[c]);
    ...
    jf.R = function(a) {
        try {
            if (a.s) a.s.call(Q, Z.O("t0"));
                ...
                if (a.D)
                    if ("t0" != a.c) J('Command ignored. Use "create" instead of "%s.create"', a.c);
                        ...
                        if (b = Z.create.apply(Z, a.b), null === b) return !0
                    }
            ...
            c = ea, a.s ? O("Exception thrown from pushed function: %s", c) : a.g ? O("Error creating a plugin instance: %s", a.G) : a.f ? O("Error registering a plugin: %s", a.G) : a.$ ? O("Error removing tracker: %s", a.G) : a.I ? O("Error calling a plugin method: %s", a.G) : O('Called method "%s" threw exception: %s', a.A, c)
        }
    };
    var Z = function(a) {
    ...
    Z.create = function(a) {
        ...
        a: {
            if (b[ce]) {
                F(67);
                if (b[xb] && "cookie" != b[xb]) {
                    J("Can't use AMP client id when storage is not 'cookie'.");
                    var d = !1;
                    break a
                }
                if (void 0 !== dc) b[R] ? J("Using client id from config instead of AMP.") : b[R] = dc;
                    ...
                    if (d)
                        if ($c(Uc, String(b[U]))) {
                            N("Requesting client id from AMP.");
                            d = !0;
                            break a
                        } else J("Could not request client id from AMP.")
                }
            }
            d = !1
        }
