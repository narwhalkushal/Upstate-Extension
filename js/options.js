// Credits to: https://davidsimpson.me/2014/05/27/add-googles-universal-analytics-tracking-chrome-extension/
// Count number of useres
...
//
// })(window, document, 'script', 'https://www.google-analytics.com/analytics_debug.js', 'ga'); // Note: https protocol here
var GA_LOCAL_STORAGE_KEY = 'ga:clientId';

if (window.localStorage) {
  ga('create', uaGoogleId, {
    'storage': 'none',
